...
TestResult AK_check_constraint_test()
{
    ...
    int year_val = 2005;
    result = AK_set_check_constraint("student", constraintYearName, "year", ">", TYPE_INT, &year_val);
    ...
    year_val = 1901;
    result = AK_check_constraint("student", "year", &year_val);
