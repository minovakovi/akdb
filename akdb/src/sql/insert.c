...
TestResult AK_insert_test()
{
    ...
    if (
        result == EXIT_SUCCESS && ((int *)(AK_get_tuple(num_table_rows, 0, testTable)->data))[0] == 1 && ((int *)(AK_get_tuple(num_table_rows + 1, 0, testTable)->data))[0] == 2 && ((float *)(AK_get_tuple(num_table_rows, 2, testTable)->data))[0] > 3.495 && ((float *)(AK_get_tuple(num_table_rows, 2, testTable)->data))[0] < 3.505 && strcmp(AK_get_tuple(num_table_rows, 1, testTable)->data, "Petrica") == 0 && (num_table_rows + 2 == AK_get_num_records(testTable)))
    {
        passed_tests++;
        printf("Test pased!\n");
    }
    ...
    if (
        result == EXIT_SUCCESS && ((int *)(AK_get_tuple(num_table_rows, 0, testTable)->data))[0] == 3 && strcmp(AK_get_tuple(num_table_rows, 1, testTable)->data, "Ariana") == 0 && (num_table_rows + 1 == AK_get_num_records(testTable)))
    {
        passed_tests++;
        printf("Test pased!\n");
    }
