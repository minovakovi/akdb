 ...
 * @brief  Function for printing header
 * @return non
 */
void printHeader(FILE *fp, AK_block *block)
{
  ...
  for (int i = 0; i < MAX_ATTRIBUTES; i++)
  {
    ...
    for (int j = 0; j < MAX_CONSTRAINTS; j++)
    {
      ...
      for (int k = 0; k < MAX_CONSTR_NAME; k++)
      {
      ...
      for (int k = 0; k < MAX_CONSTR_CODE; k++)
      {
...
/**
 * @author Marko Vukosav,
 * @brief  Function for printing tuple
 * @return non
 */
void printTuple(FILE *fp, AK_block *block)
{
...
/**
 * @author Marko Vukosav,
 * @brief  Function for printing data
 * @return non
 */
void printData(FILE *fp, AK_block *block)
{
  int i;
  int tmp = 0;
