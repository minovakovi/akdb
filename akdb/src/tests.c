...
void testing (){
    ...
    while(pickedTest<allTests){
        ...
        if (pickedTest==11||pickedTest==10)
            {
                AK_create_test_tables();
                set_catalog_constraints();
          ...
          if (pickedTest==15)
            {
             ...
             if (pickedTest==14||pickedTest==25||pickedTest==34||pickedTest==37||pickedTest==42||pickedTest==44||pickedTest==45||pickedTest==47||pickedTest==49)
            {
